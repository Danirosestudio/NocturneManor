...
public class WwiseUEPlatform_2023_1_XboxOneGDK : WwiseUEPlatform
{
	public WwiseUEPlatform_2023_1_XboxOneGDK(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
...
public class WwiseUEPlatform_2023_1_XB1 : WwiseUEPlatform_2023_1_XboxOneGDK
{
	public WwiseUEPlatform_2023_1_XB1(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) { }
}

public class WwiseUEPlatform_2023_1_XboxOneAnvil : WwiseUEPlatform_2023_1_XboxOneGDK
{
	public WwiseUEPlatform_2023_1_XboxOneAnvil(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
}
